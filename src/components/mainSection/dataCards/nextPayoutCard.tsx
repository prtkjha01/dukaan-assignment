...
const nextPayoutCard = () => {
  return (
    <div className="w-full card blue rounded-lg pt-5 pb-0">
      <header className="flex items-center gap-2 mb-4">
        <p className="card-title px-5">Next Payout</p>
        <svg
      ...
      <div className="card-body flex justify-between items-center px-5 mb-5">
        <p className="amount text-[32px] m-0">₹92,312.20</p>
        <div className="action flex items-center">
          <span className="action-text text-[16px] underline">13 orders</span>
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="25"
      ...
      <footer className="card-footer px-6 py-2 rounded-lg flex justify-between items-center">
        <p className="m-0 text-[14px] font-[300]">Next payout date:</p>
        <p className="m-0 text-[14px] font-[300]">Today, 04:00PM</p>
      </footer>
    </div>
  );
};
